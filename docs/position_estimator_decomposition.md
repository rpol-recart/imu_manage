Ваш класс действительно слишком большой и выполняет множество обязанностей. Вот план реорганизации с разделением на более мелкие, специализированные классы:
...
2. **Легче тестировать** - можно тестировать каждый компонент отдельно  
3. **Лучшая читаемость** - логика разнесена по специализированным классам
4. **Проще расширять** - новые функции добавляются в соответствующие менеджеры
5. **Меньше связанности** - компоненты слабо связаны через интерфейсы
